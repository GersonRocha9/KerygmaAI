...
jest.mock('@/formatters/textFormatters', () => ({
  ...
  extractDevotionalParts: jest.fn(() => ({
    ...
    topicos: [
      { titulo: 'A natureza da esperança', paragraphs: ['Parágrafo sobre esperança...'] },
      { titulo: 'Cultivando esperança', paragraphs: ['Como cultivar esperança...'] }
    ],
