...
jest.mock('@/services/devotionalService', () => ({
  loadDevotionalHistory: jest.fn(() => Promise.resolve([
    { id: '1', title: 'Devocional 1', theme: 'Tema 1', date: '01/01/2023', content: 'Conteúdo 1' },
    { id: '2', title: 'Devocional 2', theme: 'Tema 2', date: '02/01/2023', content: 'Conteúdo 2' }
  ])),
  clearDevotionalHistory: jest.fn(() => Promise.resolve(true)),
}));

// Mock do Alert.alert
jest.spyOn(Alert, 'alert').mockImplementation((title, message, buttons) => undefined);
