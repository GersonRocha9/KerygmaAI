import { fetchVerseOfTheDay, getVerseOfTheDay, VerseOfTheDay } from '@/services/verseService';
...
describe('verseService', () => {
  ...
  describe('fetchVerseOfTheDay', () => {
    ...
    it('deve lançar um erro quando a resposta não for ok', async () => {
      ...
      await expect(fetchVerseOfTheDay()).rejects.toThrow('Falha ao buscar o versículo do dia');
    });
