...
describe('ThemedText', () => {
  ...
  it('aplica o tipo de texto corretamente', () => {
    const { getByText } = render(<ThemedText type="title">Texto de título</ThemedText>);
  ...
  it('aplica estilo de variante corretamente', () => {
    const { getByText } = render(<ThemedText variant="secondary">Texto secundário</ThemedText>);
