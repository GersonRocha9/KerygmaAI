                  ...
                  <>
                    ...
                    {devotionalParts.introducaoParagraphs.map(
                      (paragraph: string, index: number) => (
                        <ThemedText
                          key={`intro-paragraph-${paragraph.substring(0, 10)}`}
                          variant="secondary"
                          style={[
                            styles.paragraph,
                            { marginBottom: spacing.md },
                    ...
                    <View key={`topico-${topico.titulo}`}>
                      ...
                      {topico.paragraphs.map(
                        (paragraph: string, paragraphIndex: number) => (
                          <ThemedText
                            key={`topico-${topico.titulo}-p-${paragraphIndex}`}
                            variant="secondary"
                            style={[
                              styles.paragraph,
                              { marginBottom: spacing.md },
                ...
                {devotionalParts.conclusaoParagraphs.length > 0 && (
                  <>
                    ...
                    {devotionalParts.conclusaoParagraphs.map(
                      (paragraph: string, index: number) => (
                        <ThemedText
                          key={`conclusao-${paragraph.substring(0, 10)}`}
                          variant="secondary"
                          style={[
                            styles.paragraph,
                            { marginBottom: spacing.md },
                ...
                {devotionalParts.oracaoParagraphs.length > 0 && (
                  <>
                    ...
                    {devotionalParts.oracaoParagraphs.map(
                      (paragraph: string, index: number) => (
                        <ThemedText
                          key={`oracao-${paragraph.substring(0, 10)}`}
                          variant="secondary"
                          style={[
                            styles.paragraph,
                            styles.prayerText,
